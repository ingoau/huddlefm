...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `status`           |                                                                                                                                                                                                                          | any grant                     | `state`, `volumePercent`, `playbackSeconds`, `displayMode`, `autoplay` (`off` / `related` / `huddle`), `loopMode` (`off` / `track` / `queue`), `transitionMode`, `anchorEnabled`, `yourCapabilities` (this grant), `nowPlaying`, `queue`, `queueLimit` |
...
| `settings`         | `displayMode`, `autoplay` (`off` / `related` / `huddle`, or boolean `true`=`related` / `false`=`off`), `loopMode` (`off` / `track` / `queue`, also accepted as `loop`), `transitionMode`, `anchorEnabled` (all optional) | `configure-settings`          | `changed`, plus current settings                                                                                                                                                                                                                       |
