...
| `settings`         | `displayMode`, `autoplay` (`off` / `related` / `huddle`, or boolean `true`=`related` / `false`=`off`), `loopMode` (`off` / `track` / `queue`), `transitionMode`, `anchorEnabled` (all optional) | `configure-settings`          | `changed`, plus current settings                                                                                                                                                                                                                       |
