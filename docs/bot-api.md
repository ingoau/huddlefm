...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `status`           |                                                                                                                                                         | any grant                     | `state`, `volumePercent`, `playbackSeconds`, `displayMode`, `autoplay` (`off` / `related` / `huddle`), `transitionMode`, `anchorEnabled`, `yourCapabilities` (this grant), `nowPlaying`, `queue`, `queueLimit` |
...
| `settings`         | `displayMode`, `autoplay` (`off` / `related` / `huddle`, or boolean `true`=`related` / `false`=`off`), `transitionMode`, `anchorEnabled` (all optional) | `configure-settings`          | `changed`, plus current settings                                                                                                                                                                               |
